const innerContainerReference = document.querySelector(
...
const updateFeaturedHousingPadding = () => {
  featuredHouses.style.paddingLeft =
    innerContainerReference.offsetLeft + 10 + "px";
};
          ...
          <div class="border p-2.5 rounded-lg bg-white w-full h-full">
            ...
            <div class="relative">
              ...
              <img
                ...
                class="object-cover w-full rounded-lg h-80 xs:h-86"
              />
              <!-- tag -->
              ${
                tag && tag === "new-house"
            ...
            <!-- title section -->
            <div class="flex justify-between mt-2 xs:mt-3.5">
              <!-- title -->
            ...
            <!-- view more button -->
            <div class="flex justify-center w-full text-white mt-3 xs:mt-5">
