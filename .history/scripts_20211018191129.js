...
const updateFeaturedHousingPadding = () => {
  ...
  // featuredHouses.style.color = innerContainer.offsetLeft;
};

updateFeaturedHousingPadding();
document.addEventListener("resize", updateFeaturedHousingPadding);

const card = `<div class="flex-none w-full px-4 sm:w-1/2 md:w-1/3 lg:w-1/4">
