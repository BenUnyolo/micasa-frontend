...
const houseButton = document.querySelector("");
const villaButton = document.querySelector("");
const apartmentButton = document.querySelector("");
...
houseButton.addEventListener("click", console.log("clicked"));
villaButton.addEventListener("click", console.log("clicked"));
apartmentButton.addEventListener("click", console.log("clicked"));

featuredHouses.innerHTML = cards + cards;
