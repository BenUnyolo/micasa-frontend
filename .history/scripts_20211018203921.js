...
houseButton.addEventListener("onClick", () => console.log("clicked"));
villaButton.addEventListener("onClick", () => console.log("clicked"));
apartmentButton.addEventListener("onClick", () => console.log("clicked"));
